...
New-XLFile -Path c:\temp\out3.xlsx -PassThru |
    Add-XLSheet -Name 'Sheet 1' |
        ...
        Add-XLTable -Name Table2 -Data $data -Columns  @{Name='A';Type=[int]},@{Name='B';Type=[int]},@{Name='C';Type=[float]},@{Name='Date';Type=[DateTime];NumberFormat=[XLNumberFormat]::Date} -PassThru |
